...
.method constructor <init>(Lcom/jodo/gson/Gson;)V
    ...
    iput-object p1, p0, Lcom/jodo/gson/Gson$3;->this$0:Lcom/jodo/gson/Gson;
...
# virtual methods
.method public read(Lcom/jodo/gson/stream/JsonReader;)Ljava/lang/Double;
    .locals 2
...
.method public bridge synthetic read(Lcom/jodo/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/jodo/gson/Gson$3;->read(Lcom/jodo/gson/stream/JsonReader;)Ljava/lang/Double;
...
.method public write(Lcom/jodo/gson/stream/JsonWriter;Ljava/lang/Number;)V
    ...
    iget-object v2, p0, Lcom/jodo/gson/Gson$3;->this$0:Lcom/jodo/gson/Gson;

    # invokes: Lcom/jodo/gson/Gson;->checkValidFloatingPoint(D)V
    invoke-static {v2, v0, v1}, Lcom/jodo/gson/Gson;->access$000(Lcom/jodo/gson/Gson;D)V
...
.method public bridge synthetic write(Lcom/jodo/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/jodo/gson/Gson$3;->write(Lcom/jodo/gson/stream/JsonWriter;Ljava/lang/Number;)V
