.class final Lcom/jodo/gson/internal/bind/TypeAdapters$2;
...
.method public final bridge synthetic read(Lcom/jodo/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/jodo/gson/internal/bind/TypeAdapters$2;->read(Lcom/jodo/gson/stream/JsonReader;)Ljava/util/BitSet;
...
.method public final read(Lcom/jodo/gson/stream/JsonReader;)Ljava/util/BitSet;
    .locals 7
    ...
    :goto_1
    sget-object v5, Lcom/jodo/gson/stream/JsonToken;->END_ARRAY:Lcom/jodo/gson/stream/JsonToken;

    if-eq v0, v5, :cond_4

    sget-object v5, Lcom/jodo/gson/internal/bind/TypeAdapters$32;->$SwitchMap$com$jodo$gson$stream$JsonToken:[I
    ...
    invoke-direct {v1, v0}, Lcom/jodo/gson/JsonSyntaxException;-><init>(Ljava/lang/String;)V

    throw v1

    :pswitch_0
    invoke-virtual {p1}, Lcom/jodo/gson/stream/JsonReader;->nextInt()I
...
.method public final bridge synthetic write(Lcom/jodo/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/jodo/gson/internal/bind/TypeAdapters$2;->write(Lcom/jodo/gson/stream/JsonWriter;Ljava/util/BitSet;)V

    return-void
.end method

.method public final write(Lcom/jodo/gson/stream/JsonWriter;Ljava/util/BitSet;)V
    .locals 4
    ...
    invoke-virtual {p1, v2, v3}, Lcom/jodo/gson/stream/JsonWriter;->value(J)Lcom/jodo/gson/stream/JsonWriter;
